    ...
    <footer className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-12">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/membership" className="text-gray-300 hover:text-blue-400 transition-all">Membership</Link></li>
              <li><Link to="/contact" className="text-gray-300 hover:text-blue-400 transition-all">Contact</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 text-center">
          <p className="text-gray-400">&copy; {new Date().getFullYear()} IETE. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
