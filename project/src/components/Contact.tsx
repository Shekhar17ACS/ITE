...
import img1 from '../assets/secretary.png';
import img2 from '../assets/administraion.png'
import img3 from '../assets/accounts.png'
import img4 from '../assets/corporatem.png'
import img5 from '../assets/organigation.png'
import img6 from '../assets/award.png'
import img7 from '../assets/examination.png'
import img8 from '../assets/itsport.png';
import img9 from '../assets/activity.png';
...
export function Contact() {
  ...
  <img
    ...
    className="w-full md:w-[450px] h-[200px] md:h-[250px] rounded-lg object-cover"
  />
</div>
        ...
        <div className="border border-dashed border-gray-300 p-4 md:p-6 mb-6 rounded-lg flex flex-col md:flex-row-reverse">
          <div className="md:w-1/3 pl-0 md:pl-6 mb-4 md:mb-0">
            <img
              src={img2}
